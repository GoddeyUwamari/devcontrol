...
const pricingTiers: PricingTier[] = [
  {
    ...
    features: [
      ...
      'Cost Overview (real-time spend tracking)',
      'Security Overview',
      'IAM & MFA Visibility',
      'Security Group Risk Detection',
      'EC2 Encryption Visibility',
  ...
  },
  {
    ...
    features: [
      ...
      'Cost Optimization — EC2, EBS, RDS, S3, Lambda, DynamoDB',
      'Reserved Instance & Rightsizing Opportunities',
...
const includesPrevious: Record<string, string> = {
  starter: 'Free',
  pro: 'Starter',
  enterprise: 'Pro',
}
          ...
          {pricingTiers.map(tier => {
            ...
            return (
              <div key={tier.tier} className="bg-white rounded-2xl flex flex-col relative" style={{ border: isPopular ? '2px solid #7c3aed' : '2px solid #e5e7eb', padding: '28px 24px', boxShadow: isPopular ? '0 8px 40px rgba(124,58,237,0.15)' : 'none' }}>
                ...
                {includesPrevious[tier.tier] && (
                  <p className="text-xs text-slate-500 font-semibold mb-3">
                    Everything in {includesPrevious[tier.tier]}, plus:
                  </p>
                )}
