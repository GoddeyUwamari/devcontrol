    ...
    <div style={{ minHeight: '100vh', background: '#F9FAFB' }}>
      ...
      <section style={{ padding: isMobile ? '32px 16px' : isTablet ? '48px 20px' : '64px 24px' }}>
        <div style={{
          ...
          <p style={{ fontSize: isMobile ? '15px' : '16px', color: '#1f2937', lineHeight: 1.8, marginBottom: '40px' }}>
          ...
          <div style={{ marginBottom: '40px' }}>
            ...
            <p style={{ fontSize: isMobile ? '15px' : '16px', color: '#1f2937', lineHeight: 1.8, marginBottom: '12px' }}>
            ...
            <p style={{ fontSize: isMobile ? '15px' : '16px', color: '#1f2937', lineHeight: 1.8 }}>
